    ...
    return (<div>
                ...
                <div className={bgColorClass}>
                    ...
                    <section className="weather-details">
                        ...
                        <div className="wind"><i className="wi wi-small-craft-advisory" >{this.state.wind}</i> 
    ...
    console.log(this.state.lat+" lat");
        ...
        Api.get({lat:this.state.lat,lng:this.state.lng})
            .then(function(data) {
               ...
               //selectedCityWeather = data.description;
